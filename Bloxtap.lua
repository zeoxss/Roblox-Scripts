...
ICON_SKINS.Image = "http://www.roblox.com/asset/?id=7115928794"
...
ICON_SCRIPT.Image = "http://www.roblox.com/asset/?id=7115686678"
...
ICON_PERFORMANCE.Image = "http://www.roblox.com/asset/?id=7115675128"
...
ICON_SELF.Image = "http://www.roblox.com/asset/?id=7117563745"
...
ICON_WORLD.Image = "http://www.roblox.com/asset/?id=7117556922"
...
addtoggle({parent=GunModRage,title='Ammo',valuename='infammo'}, function(bruh)
	weaponMOD(bruh,'Ammo',90000000000)
end)

addtoggle({parent=GunModRage,title='No Recoil',valuename='norecoil'}, function(bruh)
...
addtoggle({parent=EnvironmentRage,title='Anti Vote Kick',valuename='antivotekick'}, function(bruh) 
...
addtoggle({parent=SilentAimLegit,title='Silent Aim',valuename='silentaim'}, function(bruh) end)
...
addtoggle({parent= EntitiesVisuals_World,title='Hit Chams',valuename='hitchams'},function(callback)
end)
addcolorselectionbutton({valuename = 'hitchamsesp',parent = toggle_hitchams },function(callback)
end)
...
game.Players.LocalPlayer.Additionals.TotalDamage.Changed:Connect(function(val)
        ...
        marker.SoundId = "rbxassetid://5447626464"
        marker.Volume = 3
        marker:Play()
end)
